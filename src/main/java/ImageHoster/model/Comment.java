...
public class Comment {
    ...
    //One comment can belong to one user(owner) but one user can have multiple comments
    //FetchType is EAGER
    ...
    //One comment can belong to one image but one image can have multiple comments
    //FetchType is EAGER
